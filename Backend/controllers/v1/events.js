...
const jwtAuth = require('../../middlewares/jwtAuth'); // JWT middleware
const basicAuth = require('../../middlewares/basicAuth'); // Basic Auth middleware
...
// Crear evento (Protegido por JWT)
...
// Obtener todos los eventos (Protegido por JWT)
...
// Obtener un evento por ID (Protegido por JWT)
...
// Actualizar evento (Protegido por JWT)
...
// Eliminar evento (Protegido por JWT)
